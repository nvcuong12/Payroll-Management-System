...
| :--- | :--- | :--- |
| Nguyễn Việt Cường | - Xây dựng module quản lý các tác động đến thông tin nhân viên (`EmployeeManager`). <br> - Xây dựng module quản lý chấm công (`AttendanceManager`). <br> - Xây dựng module giao diện người dùng CLI (`App`). <br> - Doxygen comment ra tài liệu tổng quan về các hàm trong đồ án. <br> - Quay video demo đồ án. <br> - Kiểm tra lại output và nộp đồ án.| Đều đặn |
