...
private:
    ...
    double _hourlyRate = 23;  // Ví dụ: 23,000 VND/giờ
    double _overtimeRate = 34.5; // Ví dụ: 34,500 VND/giờ tăng ca
    double _holidayRate = 46; // Ví dụ: 46,000 VND/giờ làm ngày lễ
