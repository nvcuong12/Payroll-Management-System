...
private:
    ...
    double _hourlyRate = 45;  // Ví dụ: 45,000 VND/giờ
    double _overtimeRate = 67.5; // Ví dụ: 67,500 VND/giờ tăng ca
    double _holidayRate = 90; // Ví dụ: 90,000 VND/giờ làm ngày lễ
