...
EmployeeManager::EmployeeManager() {
    ...
    welfareManager.addWelfare(std::make_unique<HealthInsuranceWelfare>(0.015));  // 1.5% của nhân viên
    welfareManager.addWelfare(std::make_unique<AllowanceWelfare>(500000, "Phu cap an trua", "Ho tro chi phi an trua."));
    welfareManager.addWelfare(std::make_unique<AllowanceWelfare>(1000000, "Phu cap thai san", "Phu cap cho nhan vien nu nghi thai san."));
    welfareManager.addWelfare(std::make_unique<AllowanceWelfare>(300000, "Phu cap om dau", "Phu cap cho nhan vien nghi om."));
    welfareManager.addWelfare(std::make_unique<BonusWelfare>(static_cast<double>(2000000))); // Chỉ còn thưởng doanh thu: 2tr (Đã sửa)
