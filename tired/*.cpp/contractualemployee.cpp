...
/**
 * @brief Tính toán tổng lương của nhân viên Hợp đồng.
 *
 ...
 * @return double Giá trị lương ròng của nhân viên Hợp đồng.
 * @override
 */
double ContractualEmployee::calculateSalary(const Attendance& attendance, double bonuses, double allowances, double deductions) const
{
    ...
    SalaryDetails details = calculator.calculateSalary(attendance, employeeId, bonuses, allowances, deductions);
