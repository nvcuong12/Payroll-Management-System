...
/**
 * @brief Tính toán tổng lương của nhân viên Thực tập.
 *
 ...
 * @return double Giá trị lương ròng của nhân viên Thực tập.
 * @override
 */
double Intern::calculateSalary(const Attendance& attendance, double bonuses, double allowances, double deductions) const
{
